...
# Apply weighting with weighting factors from file 'apparun/resources/pef30/weighting_factor.csv'
unique_score = score_init.to_unique_score(isNorm=True, isWeight=True, method=MethodUniqueScore.EF30, fileweight='apparun/resources/pef30/weighting_factor.csv')
...
unique_node_scores = [score_model_node.to_unique_score(isNorm=True, isWeight=True) for score_model_node in node_scores]
